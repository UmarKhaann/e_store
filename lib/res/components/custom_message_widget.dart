  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ThemeProvider>(builder: (context, themeProvider, child) {
      return Padding(
        ...
        child: Align(
          alignment: widget.meCurrUser ? Alignment.topRight : Alignment.topLeft,
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                    ...
                    bottomRight: Radius.circular(widget.meCurrUser ? 0 : 15))),
            child: Row(
                    ...
                    : Consumer<VoiceDurationProvider>(
                        ...
                        return Row(
                          children: [
                            IconButton(
                              onPressed: () {
                                voiceDurationProvider
                                    .setIsPlayingVoiceMessage(true);
                                ChatModel.toggleVoiceMessage(
                                    context: context,
                                    fileUrl: widget.messages['voiceMessage'],
                                    whenFinished: () {
                              ...
                              icon: Icon(
                                  voiceDurationProvider.isPlayingVoiceMessage
                                      ? Icons.pause
                                      : Icons.play_arrow),
                            ...
                            Slider(
                                ...
                                max: voiceDurationProvider.isPlayingVoiceMessage
                                    ? voiceDurationProvider.voiceDuration
                                        .toDouble()
                                    : 0.0,
                                value: voiceDurationProvider
                                        .isPlayingVoiceMessage
                                    ? voiceDurationProvider.position.toDouble()
                                    : 0.0,
                                onChanged: (value) async {}),
                            if (voiceDurationProvider
                                .isPlayingVoiceMessage) ...[
                              Text(
